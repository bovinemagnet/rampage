...
NOTE: This is a reference snapshot of `docs/roadmap/roadmap.md`. It is not updated automatically. Last updated: 2026-05-15 — REST/HTTP support, multi-step scenarios, response extraction, inter-step pauses, and rich checks (regex, header, responseTime, bodyContains) shipped.
